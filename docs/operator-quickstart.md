# Operator Quickstart — Community Mobile Network Infrastructure Operations

Shortest path from clone to a verified local dry-run for **ISIC 6120** (`cloud-itonami-isic-6120`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-6120.git
cd cloud-itonami-isic-6120
```
